                    ...
                    <form action="{{ route('events.update', $event) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      maxlength="1000"
                                      placeholder="Tell people what your event is about...">{{ old('description', $event->description) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="time" 
                                       id="event_time" 
                                       name="event_time" 
                                       value="{{ old('event_time', \Carbon\Carbon::parse($event->event_time)->format('H:i')) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                       required>
                            </div>
                        </div>
